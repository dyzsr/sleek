...
let tests =
  [
    ...
    {| True /\ ({A}.{B})^* // {C}    |-  True /\ {A, C}.{B}.({A}.{B})^* : false |};
    {| True /\ {A, C}.{B}.({A}.{B})^*    |-  True /\ ({A}.{B})^* // {C} : true |};
    {| True /\ ({A, C}.{B, C})^*  |-  True /\ ({A}.{B})^* // {C}^* : true   |};
    {| True /\ ({A}.{B})^* // ({C} // {D})^*  |-  True /\ {}^* : true   |};
    ...
    "(): [0.2 -> {A} | 0.8 -> {A}]  |-  (): {} :: true";
    "(): [0.3 -> {A} | 0.7 -> {A}]  |-  (): {} :: true";
    "(): [0.3 -> {A} | 0.7 -> {A}]  |-  (): [p -> {B}] :: false";
    (* "(): {A}  |-  (p = 1): [p -> {A} | q -> {B}] :: true"; *)
    "(): {A}  |-  (): [0.3 -> {A} | 0.7 -> {B}] :: false";
    "(): [0.3 -> {A} | 0.7 -> {A}]  |-  (): {A} :: true";
    "(): [0.3 -> {A} | 0.7 -> {B}]  |-  (): {A} :: false";
    "(): [0.3 -> {A, B} | 0.7 -> {A}]  |-  (): {A} :: true";
    "(): [0.3 -> {A, B} | 0.7 -> {A}]  |-  (): [0.3 -> {B} | 0.7 -> {A}] :: true";
    "(): [0.1 -> {A} | 0.2 -> {A} | 0.7 -> {B}]  |-  (p < 0.6): [p -> {A} | q -> {B}] :: true";
    "(): [0.1 -> {A} | 0.2 -> {B, D} | 0.7 -> {C, D}]  |-  (p > 0): [p -> {A} | q -> {D}] :: true";
    "(): [0.1 -> {A} | 0.2 -> {B, D} | 0.7 -> {C, D}]  |-  (p < 0.2): [p -> {A} | q -> {D}] :: true";
    "(): [0.1 -> {A} | 0.2 -> {B, D} | 0.7 -> {C, D}]  |-  (q = 0.9): [p -> {A} | q -> {D}] :: true";
    "(): [0.3 -> {A, B} | 0.7 -> {A}]  |-  (): [0.3 -> {A} | 0.7 -> {}] :: false";
    "(): [0.3 -> {A, B} | 0.7 -> {A}]  |-  (): [0.3 -> {} | 0.7 -> {A}] :: false";
    "(): [0.3 -> {A, B} | 0.7 -> {A}]  |-  (): [0.2 -> {} | 0.8 -> {A}] :: false";
    "(): [0.3 -> {A, B} | 0.7 -> {A}]  |-  (): [0.3 -> {A, B} | 0.7 -> {A}] :: true";
    "(): [0.3 -> {A, B} | 0.7 -> {A}]  |-  (): {A} // [0.3 -> {B} | 0.7 -> {}] :: true";
    "(): [0.3 -> {A, B} | 0.7 -> {A}]  |-  (): {} :: true";
    "(): [0.3 -> {A, B} | 0.7 -> {A}]  |-  (): {A} :: true";
    ...
    "(): [0.1 -> {A, B} | 0.8 -> {A, C} | 0.1 -> {B, C}] |- (): {} :: true";
    "(): [0.1 -> {A, B} | 0.8 -> {A, C} | 0.1 -> {B, C}] |- (): [0.9 -> {A} | 0.1 -> {}] :: true";
    "(): [0.1 -> {A, B} | 0.8 -> {A, C} | 0.1 -> {B, C}] |- (): [0.9 -> {C} | 0.1 -> {}] :: true";
    "(): [0.1 -> {A, B} | 0.8 -> {A, C} | 0.1 -> {B, C}] |- (): [0.2 -> {B} | 0.8 -> {}] :: true";
    "(): [0.1 -> {A, B} | 0.8 -> {A, C} | 0.1 -> {B, C}] |- (): [0.9 -> {A} | 0.1 -> {B}] :: false";
    "(): [0.1 -> {A, B} | 0.8 -> {A, C} | 0.1 -> {B, C}] |- (): [0.9 -> {A} | 0.1 -> {C}] :: false";
    "(): [0.1 -> {A, B} | 0.8 -> {A, C} | 0.1 -> {B, C}] |- (): [0.2 -> {B} | 0.8 -> {C}] :: false";
    "(): [0.1 -> {A, B} | 0.8 -> {A, C} | 0.1 -> {B, C}] |- (): [0.2 -> {A} | 0.8 -> {B}] :: false";
    "(): [0.1 -> {A, B, C} | 0.8 -> {C, D} | 0.1 -> {B, D}] |- (): [0.9 -> {C} | 0.1 -> {}] :: true";
    "(): {A} + {B} |- (): {}*.{A} + {B} :: true";
    "(): [0.1 -> {A} | 0.9 -> {B}] |- (): [0.1 -> {}*.{A} | 0.9 -> {B}] :: true";
    "(): [0.1 -> {A} | 0.9 -> emp] |- (): {A}* :: false";
    "(): [0.5 -> {B}.[0.5 -> {C} | 0.5 -> {}] | 0.5 -> {}.{}]  |- (): [0.25 -> {}.{C} | 0.75 -> {}.{}] :: true";
    "(): [0.5 -> {B}.[0.5 -> {C} | 0.5 -> {}] | 0.5 -> {}.{}]  |- (): [0.25 -> {}.{C} | 0.75 -> {}*] :: true";
    "(): [0.5 -> {B}.[0.5 -> {C} | 0.5 -> {}] | 0.5 -> {}.{}]  |- (): [0.25 -> {}*.{C} | 0.75 -> {}*] :: true";
    "(): [0.5 -> {B}.[0.5 -> {C} | 0.5 -> {}] | 0.5 -> {}]     |- (): [0.25 -> {}*.{C} | 0.75 -> {}*] :: false";
    "(): [0.5 -> {B}.[0.5 -> {C} | 0.5 -> {}] | 0.5 -> emp]    |- (): [0.25 -> {}*.{C} | 0.75 -> {}*] :: false";
    "(): [0.5 -> {B}.[0.5 -> {C} | 0.5 -> emp] | 0.5 -> {}.{}] |- (): [0.25 -> {}*.{C} | 0.75 -> {}*] :: false";
    "(): [0.5 -> {B}.[0.5 -> {C} | 0.5 -> emp] | 0.5 -> {}]    |- (): [0.25 -> {}*.{C} | 0.75 -> {}*] :: true";
    "(): [0.5 -> {B}.[0.5 -> {C} | 0.5 -> emp] | 0.5 -> emp]   |- (): [0.25 -> {}*.{C} | 0.75 -> {}*] :: false";
    "(): {A}.[0.5 -> {B}.[0.5 -> {C} | 0.5 -> {}] | 0.5 -> {}.{}] |- (): [0.25 -> {}*.{C} | 0.75 -> {}*] :: true";
    ...
    "(): [0.5 -> {A}.[0.5 -> {C} | 0.5 -> {D}] | 0.5 -> {B}.[0.5 -> {C} | 0.5 -> {D}]] |- (): [0.25 -> {A}.{C} | 0.75 -> {}.{}] :: true";
    "(): [0.25 -> {A}.{C} | 0.25 -> {A}.{D} | 0.25 -> {B}.{C} | 0.25 -> {B}.{D}] |- (): [0.25 -> {A}.{C} | 0.75 -> {}.{}] :: true";
    "(): [0.5 -> [0.5 -> {A}.{C} | 0.5 -> {A}.{D}] | 0.5 -> [0.5 -> {B}.{C} | 0.5 -> {B}.{D}]] |- (): [p -> {A}.{C} | q -> {}.{}] :: true";
    "(): [0.5 -> [0.5 -> {A}.{C} | 0.5 -> {A}.{D}] | 0.5 -> [0.5 -> {B}.{C} | 0.5 -> {B}.{D}]] |- (): [0.25 -> {A}.{C} | 0.75 -> {}.{}] :: true";
    (* "(): [0.5 -> {A} | 0.5 -> {B}].[0.5 -> {C} | 0.5 -> {D}] |- (): [p -> {A}.{C} | q -> {}.{}] :: true"; *)
    (* "(): [0.5 -> {A} | 0.5 -> {B}].[0.5 -> {C} | 0.5 -> {D}] |- (): [0.25 -> {A}.{C} | 0.75 -> {}.{}] :: true"; *)
    "(): [0.4 -> {A} | 0.6 -> {B}]*  |-  (): [0.4 -> {A} | 0.6 -> {B}]* :: true";
    "(): [0.4 -> {A} | 0.6 -> {B}]*  |-  (): [0.4 -> {A} | 0.6 -> {}]* :: true";
    (* "(): [0.4 -> {A} | 0.6 -> {B}]*  |-  (): [0.4 -> {A}* | 0.6 -> {}*] :: false"; *)
    "(): [0.4 -> {A} | 0.6 -> {B}]*  |-  (): [p -> {A}* | q -> {}*] :: true";
    {|  (): {Src}.{SW1}.[p12 -> {SW2} | p13 -> {SW3}.[p32 -> {SW2} | p3f -> _|_] | p1f -> _|_].[p2d -> {Dest} | p2f -> _|_]
    |-  (): {Src}.[success -> {}*.{Dest} | failure -> _|_] :: true
    |};
  ]
