let tests =
  [
    ...
    "(): [0.1 -> {A, B} | 0.8 -> {A, C} | 0.1 -> {B, C}] |- (): [0.9 -> {A} | 0.1 -> {!A}] :: true";
    "(): [0.1 -> {A, B} | 0.8 -> {A, C} | 0.1 -> {B, C}] |- (): [0.9 -> {C} | 0.1 -> {!C}] :: true";
    "(): [0.1 -> {A, B} | 0.8 -> {A, C} | 0.1 -> {B, C}] |- (): [0.2 -> {B} | 0.8 -> {!B}] :: true";
    "(): [0.1 -> {A, B} | 0.8 -> {A, C} | 0.1 -> {B, C}] |- (): [0.9 -> {A} | 0.1 -> {B}] :: true";
    "(): [0.1 -> {A, B} | 0.8 -> {A, C} | 0.1 -> {B, C}] |- (): [0.9 -> {A} | 0.1 -> {C}] :: true";
    "(): [0.1 -> {A, B} | 0.8 -> {A, C} | 0.1 -> {B, C}] |- (): [0.2 -> {B} | 0.8 -> {C}] :: true";
    (* "(): [0.1 -> {A, B} | 0.8 -> {A, C} | 0.1 -> {B, C}] |- (): [0.2 -> {A} | 0.8 -> {B}] :: false"; *)
    "(): [0.1 -> {A, B, C} | 0.8 -> {C, D} | 0.1 -> {B, D}] |- (): [0.9 -> {C} | 0.1 -> {}] :: true";
    "(): {A}.[0.5 -> {B}.[0.5 -> {C} | 0.5 -> {}] | 0.5 -> {}.{}] |- (): [0.25 -> {}*.{C} | 0.75 -> {}*] :: true";
    "(): {A}.[0.5 -> {B}.[0.5 -> {C} | 0.5 -> {}] | 0.5 -> {}.{}] |- (): [0.25 -> {}*.{C} | 0.75 -> {!C}*] :: true";
    (* "(): {A}.[0.5 -> {B}.[0.5 -> {C} | 0.5 -> {}] | 0.5 -> {}.{}] |- (): [0.75 -> {}*.{C} | 0.25 -> {!C}*] :: false"; *)
    "(): {A}.[0.5 -> {B}.[0.5 -> {C} | 0.5 -> emp] | 0.5 -> emp] |- (): [0.25 -> {}*.{C} | 0.75 -> {}*] :: true";
    "(): {A}.[0.5 -> {B}.[0.5 -> {C} | 0.5 -> emp] | 0.5 -> emp] |- (): [0.25 -> {}*.{C} | 0.75 -> {!C}*] :: true";
    "(): {A}.[0.5 -> {B}.[0.5 -> {C} | 0.5 -> emp] | 0.5 -> emp] |- (): [0.75 -> {}*.{C} | 0.25 -> {!C}*] :: false";
